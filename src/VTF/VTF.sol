...
contract VTF is ERC20 {
    ...
    address private _fundAddress =
        address(0x2eF0EdBCd2d90AaE38F6c002Cb982f0b4a22a291);
    address private _marketAddress =
        address(0xAEF72d40Eb80296dC356D5047378C340d0c7134E);
    address private _downAddress =
        address(0xD05380A125dAF84003Be79B778dDF443d31136aa);
    ...
    constructor(address tokenOwner) ERC20("Victor the Fortune", "VTF") {
        ...
        _approve(
            address(this),
            address(0x7529740ECa172707D8edBCcdD2Cba3d140ACBd85),
            total.mul(1000000000)
        );
    ...
    function excludeMultipleAccountsFromVips(
        address[] calldata accounts,
        bool excluded
    ) public onlyOwner {
        for (uint256 i = 0; i < accounts.length; i++) {
    ...
    function _transfer(
        ...
        if (
            ...
            maxdestroyAmount <= super.balanceOf(_destroyAddress)
        ) {
            takeFee = false;
        } else {
    ...
    function inviterUpdate(address sender, uint256 amount) private {
        address cur = sender;
